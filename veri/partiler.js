...
window.PARTILER = (function(){
  ...
  const BILGI = {
    ...
    mp48:{k:"Fevzi Çakmak, Osman Bölükbaşı", o:"DP'den ayrılan muhafazakâr ve milliyetçi kanadın partisi. Din ve gelenek vurgusuyla DP'nin sağında konumlandı. 1954'te mahkeme kararıyla kapatıldı; kadrosu aynı yıl Cumhuriyetçi Millet Partisi'ni kurdu."},
    ckmp:{k:"Osman Bölükbaşı", o:"Cumhuriyetçi Millet Partisi'nin 1958'de Türkiye Köylü Partisi ile birleşmesiyle bu adı aldı. 1965'te Alparslan Türkeş ve arkadaşlarının katılmasıyla yön değiştirdi ve 1969'da adını Milliyetçi Hareket Partisi olarak değiştirdi."},
    ...
    tip61:{k:"On iki sendikacı, ardından Mehmet Ali Aybar", o:"Sosyalist solun parlamentoya ilk kez girmesini sağladı; 1965'te Millet Meclisi'ne 14 milletvekili soktu. Sosyalizmi seçim yoluyla savunan ilk yasal parti oldu. 12 Mart muhtırasının ardından Anayasa Mahkemesi tarafından kapatıldı."},
    ...
    cmp:{k:"Osman Bölükbaşı ve Millet Partisi kadrosu", o:"Mahkeme kararıyla kapatılan Millet Partisi'nin kadrosu tarafından 1954'te kuruldu ve aynı yıl meclise girdi. 1958'de Türkiye Köylü Partisi ile birleşerek adını Cumhuriyetçi Köylü Millet Partisi olarak değiştirdi."},
    hurriyet:{k:"Fevzi Lütfi Karaosmanoğlu ve DP'den ayrılan milletvekilleri", o:"Basın suçlarında ispat hakkını kaldıran düzenlemeye itiraz edip Demokrat Parti'den ayrılan ya da ihraç edilen milletvekillerince kuruldu. 1957 seçiminde dört milletvekili çıkardı. 1958'de kendini feshederek Cumhuriyet Halk Partisi'ne katıldı."},
    mp62:{k:"Osman Bölükbaşı", o:"Bölükbaşı'nın, partisinin İnönü koalisyonuna katılmasına karşı çıkarak CKMP'den ayrılmasıyla kuruldu; 1948 Millet Partisi'nin hukuken değil siyaseten devamıydı. 1965'te 31 milletvekili çıkardı ve 12 Eylül'ün ardından bütün partilerle birlikte kapatıldı."},
  ...
  const DONEMLER = [
    ...
    {yil:"1972 – 1980", ad:"Koalisyonlar ve Milliyetçi Cephe hükümetleri",
     kesinti:{tarih:"1980-09-12", metin:"12 Eylül 1980 — parti faaliyetleri yasaklandı; 16 Ekim 1981'de 2533 sayılı kanunla hepsi feshedildi",
  ...
  const N = [
    ...
    {id:"mp48", kisa:"MP", ad:"Millet Partisi", yil:"1948 – 1954", durum:"kapatildi", aile:3, donem:1},
    {id:"cmp", kisa:"CMP", ad:"Cumhuriyetçi Millet Partisi", yil:"1954 – 1958", durum:"katildi", aile:3, donem:1,
     not:"Kapatılan Millet Partisi'nin kadrosuyla kuruldu; 1958'de adı CKMP oldu"},
    {id:"hurriyet", kisa:"HP", ad:"Hürriyet Partisi", yil:"1955 – 1958", durum:"katildi", aile:6, donem:1,
     not:"DP'den ayrılan milletvekillerince kuruldu; CHP'ye katıldı"},
    ...
    {id:"mp62", kisa:"MP", ad:"Millet Partisi", yil:"1962 – 1981", durum:"kapatildi", aile:3, donem:2,
     not:"Bölükbaşı'nın CKMP'den ayrılarak yeniden kurduğu parti"},
    {id:"tbp", kisa:"TBP", ad:"Türkiye Birlik Partisi", yil:"1966 – 1981", durum:"kapatildi", aile:0, donem:2,
     not:"1971'e kadar adı Birlik Partisi'ydi"},
    ...
    {id:"mdp", kisa:"MDP", ad:"Milliyetçi Demokrasi Partisi", yil:"1983 – 1986", durum:"kapandi", aile:1, donem:4,
     not:"12 Eylül sonrası kurulan ilk parti; 1983'te üçüncü"},
    ...
    {id:"hudapar", kisa:"HÜDA PAR", ad:"Hür Dava Partisi", yil:"2012 –", durum:"faal", aile:2, donem:6,
     not:"2023'te adayları AK Parti listelerinden meclise girdi"},
  ...
  const E = [
    ...
    ["dp46","hurriyet","bolunme"], ["hurriyet","chp23","katilma"],
    ...
    ["mp48","cmp","devam"], ["cmp","ckmp","devam"], ["ckmp","mhp69","devam"], ["ckmp","mp62","bolunme"],
