...
| Dönem | Aday kayıtlar |
|---|---|
| 0 · 1923–1945 | genel (tek parti) 1923, 1927, 1931, 1935, 1939, 1943; TBMM CB seçimleri; ara seçimler; hükümetler |
| 1 · 1946–1960 | genel 1946, 1950, 1954, 1957; TBMM CB; ara seçimler (örn. 1951); hükümetler. **Kap (27 Mayıs):** MBK dönemi hükümetleri, 1961 anayasa referandumu |
...
**Interfaces:**
- Consumes: spesifikasyon §9; Görev 9'da verilen yerel seçim başlangıç yılı kararı (varsayılan 1963 — kullanıcı farklı karar verdiyse metin ona göre yazılır).
...
```html
    <section id="sandik">
      ...
      <p>Sandık bölümü 1923'ten bugüne genel seçimleri, 1963'ten bugüne yerel seçimleri,
